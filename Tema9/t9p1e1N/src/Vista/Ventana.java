    ...
    public boolean validar(){
        try
        {
            ...
            if (tfEdad.getText().isEmpty())
                throw new CampoVacioException(2);
            if (tfProfesion.getText().isEmpty())
                throw new CampoVacioException(3);
            if (tfTelefono.getText().isEmpty())
                throw new CampoVacioException(4);
            ...
            if (!mat.matches())
                throw new FormatoNoValidoException(2);
            
            patron = Pattern.compile("^[A-Z][a-z ]*$");
            mat = patron.matcher(tfProfesion.getText());
            if (!mat.matches())
                throw new FormatoNoValidoException(3);
            
            patron = Pattern.compile("^[6789][0-9]{8}$");
            mat = patron.matcher(tfTelefono.getText());
            if (!mat.matches())
                throw new FormatoNoValidoException(4);
            
            return true;
        }
        catch(CampoVacioException|FormatoNoValidoException e)
        {
