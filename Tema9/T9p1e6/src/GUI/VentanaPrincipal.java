...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mNuevaInscripcion = new javax.swing.JMenuItem();
        jMenu3 = new javax.swing.JMenu();
        mAsistencia = new javax.swing.JMenuItem();
        ...
        mNuevaInscripcion.setText("Nueva");
        mNuevaInscripcion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mNuevaInscripcionActionPerformed(evt);
            }
        });
        jMenu2.add(mNuevaInscripcion);

        jMenuBar1.add(jMenu2);

        jMenu3.setText("Asistencia");

        mAsistencia.setText("Asistencia por evento");
        mAsistencia.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mAsistenciaActionPerformed(evt);
            }
        });
        jMenu3.add(mAsistencia);
    ...
    private void mNuevaInscripcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mNuevaInscripcionActionPerformed
       Controlador.nuevaInscripcion();
    }//GEN-LAST:event_mNuevaInscripcionActionPerformed

    private void mAsistenciaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mAsistenciaActionPerformed
        try
        {
             String evento=JOptionPane.showInputDialog(this,"Indica el evento para el que solicitas la lista de asistentes");
             if (validarNombre(evento))
             {
                    String datos = Controlador.mostrarAsistencia(evento);
                    JOptionPane.showMessageDialog(this,datos);
             }
        }
        catch(Exception e)
        {
            JOptionPane.showMessageDialog(this,"Problemas con el nombre del evento. Es posible que no exista.");
        }
    }//GEN-LAST:event_mAsistenciaActionPerformed

    private boolean validarNombre(String evento) throws Exception{
        return true;
    }
    ...
    private javax.swing.JMenuItem mAsistencia;
    private javax.swing.JMenuItem mEditar;
    private javax.swing.JMenuItem mEliminar;
    private javax.swing.JMenuItem mNuevaInscripcion;
